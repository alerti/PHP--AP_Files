...
include_once '/opt/lampp/htdocs/api/objects/studentapplication.php';
...
// initialize object
$applicant = new StudentApplication($db);
...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
       ...
       "status"=>$StudentApplicationStatusId,
       "client"=>$ClientID,
       "course"=>$CourseId,
       "studentid"=>$StudentId,
       "applicationdate"=>$ApplicationDate,
       "approvaldate"=>$ApplicationApprovalDate,
