...
class StudentApplication{
    ...
    private $conn;
    private $table_name = "StudentApplication";

  
    // object properties
    public $StudentApplicationId;
    public $StudentApplicationStatusId;
    public $ClientID;
    public $CourseId;
    public $StudentId;
    public $ApplicationDate;
    public $ApplicationApprovalDate;
    public $CreatedOn;
    public $CreatedBy;
...
function read(){
    ...
    $query = "SELECT
                	StudentApplicationId,StudentApplicationStatusId,ClientID,CourseId,StudentId,ApplicationDate,ApplicationApprovalDate,CreatedOn,CreatedBy
            FROM
                " . $this->table_name . " 
            ORDER BY
            CreatedOn DESC";
