<?php
class CourseyrSemesterunit{
  
    // database connection and table name
    private $conn;
    private $table_name = "CourseYearSemestersUnits";
  
    // object properties
    public   $CourseYearSemestersUnitsId;
...
function read(){
    ...
    // select all query
    $query = "SELECT 
                CourseYearSemestersUnitsId,CourseYearSemestersId,UnitId,ClientID,CreatedBy
                FROM
                " . $this->table_name . " 
            ORDER BY
            CreatedOn DESC";
